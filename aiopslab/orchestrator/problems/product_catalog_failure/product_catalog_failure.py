...
class ProductCatalogServiceFailureBaseTask:
    def __init__(self):
...
################## Detection Problem ##################
class ProductCatalogServiceFailureDetection(
    ProductCatalogServiceFailureBaseTask, DetectionTask
):
    def __init__(self):
...
class ProductCatalogServiceFailureLocalization(
    ProductCatalogServiceFailureBaseTask, LocalizationTask
):
    def __init__(self):
        ProductCatalogServiceFailureBaseTask.__init__(self)
