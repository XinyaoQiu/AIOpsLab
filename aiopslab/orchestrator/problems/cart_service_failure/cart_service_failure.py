...
class CartServiceFailureBaseTask:
    def __init__(self):
...
################## Detection Problem ##################
class CartServiceFailureDetection(CartServiceFailureBaseTask, DetectionTask):
    def __init__(self):
...
class CartServiceFailureLocalization(CartServiceFailureBaseTask, LocalizationTask):
    def __init__(self):
        CartServiceFailureBaseTask.__init__(self)
