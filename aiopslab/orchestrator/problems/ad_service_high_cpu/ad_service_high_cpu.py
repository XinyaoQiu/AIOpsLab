...
class AdServiceHighCpuBaseTask:
    def __init__(self):
...
################## Detection Problem ##################
class AdServiceHighCpuDetection(AdServiceHighCpuBaseTask, DetectionTask):
    def __init__(self):
...
class AdServiceHighCpuLocalization(AdServiceHighCpuBaseTask, LocalizationTask):
    def __init__(self):
        AdServiceHighCpuBaseTask.__init__(self)
