...
class AdServiceManualGcBaseTask:
    def __init__(self):
...
################## Detection Problem ##################
class AdServiceManualGcDetection(AdServiceManualGcBaseTask, DetectionTask):
    def __init__(self):
...
class AdServiceManualGcLocalization(AdServiceManualGcBaseTask, LocalizationTask):
    def __init__(self):
        AdServiceManualGcBaseTask.__init__(self)
