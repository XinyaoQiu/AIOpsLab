...
class PaymentServiceFailureBaseTask:
    def __init__(self):
...
################## Detection Problem ##################
class PaymentServiceFailureDetection(PaymentServiceFailureBaseTask, DetectionTask):
    def __init__(self):
...
class PaymentServiceFailureLocalization(
    PaymentServiceFailureBaseTask, LocalizationTask
):
    def __init__(self):
        PaymentServiceFailureBaseTask.__init__(self)
