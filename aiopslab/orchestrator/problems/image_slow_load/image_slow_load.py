...
################## Detection Problem ##################
class ImageSlowLoadDetection(ImageSlowLoadBaseTask, DetectionTask):
    def __init__(self):
...
class ImageSlowLoadLocalization(ImageSlowLoadBaseTask, LocalizationTask):
    def __init__(self):
        ImageSlowLoadBaseTask.__init__(self)
