...
from aiopslab.generators.fault.inject_high_cpu_utilization import HighCPUUtilizationInjector
...
class NewInjectHighCPUHotelResBaseTask:
    def __init__(self):
    ...
    def inject_fault(self):
        ...
        injector = HighCPUUtilizationInjector(duration=30)
        injector._inject()
        print(f"Namespace: {self.namespace}\n")

    def recover_fault(self):
        print("== Fault Recovery ==")
        injector = HighCPUUtilizationInjector()
        injector._recover()
        print(f"Namespace: {self.namespace}\n")


################## Detection Problem ##################
class NewInjectHighCPUHotelResDetection(NewInjectHighCPUHotelResBaseTask, DetectionTask):
    def __init__(self):
        NewInjectHighCPUHotelResBaseTask.__init__(self)
...
class NewInjectHighCPUHotelResLocalization(NewInjectHighCPUHotelResBaseTask, LocalizationTask):
    def __init__(self):
        NewInjectHighCPUHotelResBaseTask.__init__(self)
...
class NewInjectHighCPUHotelResAnalysis(NewInjectHighCPUHotelResBaseTask, AnalysisTask):
    def __init__(self):
        NewInjectHighCPUHotelResBaseTask.__init__(self)
...
################## Mitigation Problem ##################
class NewInjectHighCPUHotelResMitigation(NewInjectHighCPUHotelResBaseTask, MitigationTask):
    def __init__(self):
        NewInjectHighCPUHotelResBaseTask.__init__(self)
