...
################## Detection Problem ##################
class K8SOperatorInvalidAffinityTolerationDetection(
    K8SOperatorInvalidAffinityTolerationBaseTask, DetectionTask
):
    def __init__(self):
...
class K8SOperatorInvalidAffinityTolerationLocalization(
    K8SOperatorInvalidAffinityTolerationBaseTask, LocalizationTask
):
    def __init__(self):
        K8SOperatorInvalidAffinityTolerationBaseTask.__init__(self)
