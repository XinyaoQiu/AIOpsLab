...
class K8SOperatorWrongUpdateStrategyBaseTask:
    ...
    def recover_fault(self):
        ...
        print(f"Recovered wrong update strategy failure of the TiDB cluster\n")


################## Detection Problem ##################
class K8SOperatorWrongUpdateStrategyDetection(
    K8SOperatorWrongUpdateStrategyBaseTask, DetectionTask
):
    def __init__(self):
        K8SOperatorWrongUpdateStrategyBaseTask.__init__(self)
...
class K8SOperatorWrongUpdateStrategyLocalization(
    K8SOperatorWrongUpdateStrategyBaseTask, LocalizationTask
):
    def __init__(self):
        K8SOperatorWrongUpdateStrategyBaseTask.__init__(self)
