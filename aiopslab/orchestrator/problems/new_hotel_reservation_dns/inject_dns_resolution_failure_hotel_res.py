...
from aiopslab.generators.fault.inject_dns_resolution_failure import DNSResolutionFaultInjector
...
class NewDNSResolutionHotelResBaseTask:
    def __init__(self):
    ...
    def inject_fault(self):
        ...
        injector = DNSResolutionFaultInjector(namespace=self.namespace)
        injector._inject()
...
################## Detection Problem ##################
class NewDNSResolutionHotelResDetection(NewDNSResolutionHotelResBaseTask, DetectionTask):
    def __init__(self):
        NewDNSResolutionHotelResBaseTask.__init__(self)
...
class NewDNSResolutionHotelResLocalization(NewDNSResolutionHotelResBaseTask, LocalizationTask):
    def __init__(self):
        NewDNSResolutionHotelResBaseTask.__init__(self)
...
class NewDNSResolutionHotelResAnalysis(NewDNSResolutionHotelResBaseTask, AnalysisTask):
    def __init__(self):
        NewDNSResolutionHotelResBaseTask.__init__(self)
...
################## Mitigation Problem ##################
class NewDNSResolutionHotelResMitigation(NewDNSResolutionHotelResBaseTask, MitigationTask):
    def __init__(self):
        NewDNSResolutionHotelResBaseTask.__init__(self)
